    ...
    return (
        <div style={{ backgroundColor: '#F1F2F5' }}>
            ...
            <div className="d-flex justify-content-between margin_main_x mt-5">
                <div className="d-flex justify-content-between align-items-end" style={{ width: '38%' }}>
                ...
                <div className="d-flex justify-content-between right_tracking_div p-3" style={{ width: '42%' }}>
